...
def load_dataset(input_shape):
    ...
    for i in range(len(subject_list)):
        ...
        # print('START: Normalizing MIT-BIH ' + subject_list[i])
        signal = preprocess.X_process(signal)
    ...
    #
    X_train = preprocess.normalizing(X_train_orig)
    X_test = preprocess.normalizing(X_test_orig)
